...
class PrincipalTest {
	...
	Empresa emp = new Empresa("30112223334", "Expreso Libre", 30000);
	...
	public void testAgregarDestinoDuplicado() {
		emp.agregarDestino("Cordoba", 350);
		Assertions.assertThrows(RuntimeException.class, () -> emp.agregarDestino("Cordoba", 320));
	}

	@Test
	public void testIniciarViajeDeTransporteNoRegistrado() {
		Assertions.assertThrows(RuntimeException.class, () -> emp.iniciarViaje("AC314PI"));
	}
	...
	public void testFinalizarViajeNoIniciado() {
		emp.agregarTrailer("AC314PI", 12000, 60, true, 5, 100);
		Assertions.assertThrows(RuntimeException.class, () -> emp.finalizarViaje("AC314PI"));
	}
	...
	public void testTransIguales() {
		...
		assertEquals("AB271NE", emp.obtenerTransporteIgual("AD235NP"));
	}
