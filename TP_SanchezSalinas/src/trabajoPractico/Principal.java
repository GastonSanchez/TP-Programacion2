...
public class Principal {
	...
	public static void main(String[] args) {
		...
		System.out.println("Invenario del deposito refrigerado: \n" +e.mostrarInventarioRefrigerado());
		...
		System.out.println("Invenario del deposito no refrigerado: \n" +e.mostrarInventarioNoRefrigerado());
		
		//volumen = e.cargarTransporte("AA333XQ");
		//System.out.println("Se cargaron " + volumen +" metros cubicos en el transporte AA333XQ");
		
		//e.iniciarViaje("AA333XQ");
		System.out.println("Costo del viaje:" + e.obtenerCostoViaje("AA333XQ"));
		System.out.println("Costo del viaje:" + e.obtenerCostoViaje("AB555MN"));
